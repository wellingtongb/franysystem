                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <select name="tipo_documento" id="tipo_documento" class="form-control {{ $errors->has('tipo_documento') ? 'is-invalid' : '' }}">
                                            <option value="0"></option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" id="numero_documento" name="numero_documento" class="form-control {{ $errors->has('numero_documento') ? 'is-invalid' : ''}}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" id="telefone" name="telefone" class="form-control {{ $errors->has('telefone') ? 'is-invalid' : ''}}">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" class="form-control {{ $errors->has('numero') ? 'is-invalid' : ''}}" name="numero" 
                                        id="numero">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('cep') ? 'is-invalid' : ''}}" name="cep" 
                                        id="cep">
                                        @if($errors->has('cep'))
                                        <div class='invalid-feedback'>
                                            {{$errors->first('cep')}}
